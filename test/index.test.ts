...
test('Interesting edge cases', () => {
  expect(createIntegerRangeRegExp(0, 1000000).source).toMatchInlineSnapshot(`"(?:0|[1-9]|[1-9]\\d{1,5}|1000000)"`)
...
test('Options', () => {
  expect(createIntegerRangeRegExp(0, 100, {exact: true}).source).toMatchInlineSnapshot(`"^(?:0|[1-9]|[1-9]\\d|100)$"`)
})
